      /IF NOT DEFINED(PROTOTYPE_MTOM01002)
      ...
      *  Do not change or remove this compiler condition!
      ...
      /ENDIF
      /IF NOT DEFINED(PROTOTYPE_DEFINED_MTOM01002)
      /DEFINE PROTOTYPE_DEFINED_MTOM01002
      *
      * INFO:
      ...
      * module:   MTOM01
      *
     D ArchiveServerPort_getFile...
     D                 PR                  likeds(tns_getFileResponse_t)
     D                                     extproc('ArchiveServerPort_getFile')
     D  i_tns_getFile                      likeds(tns_getFileRnmd_t)
 ...
 CPY  /COPY ZENEXMPL/QWSDL,MTOM01                  Web Service: Web Service Proc
      ...
      *
      /ENDIF
      /IF DEFINED(PROTOTYPE_MTOM01002)
      /EOF
      /ENDIF
      * ---------------------------------------------------------------------
      *
 ...
 CPY  /COPY QWSDL2RPG,PWSDL2R42                    WSDL2RPG: User name and password
      ...
      * tns:getFile
     D tns_getFileRnmdSerializer...
     D                 PR
     D                                     extproc('tns_getFileRnmdSerializer')
     D  i_hOutStream                       like(wsdl_hStream_t)
     D                                     const
     D  i_tns_getFileRnmd...
     D                                     likeds(tns_getFileRnmd_t)
     D  i_elemName                         like(wsdl_name_t)
     D                                     const
      *
     D tns_getFileResponseRnmdStart...
     D                 PR
     D                                     extproc('tns_getFileResponseRnmdStar+
     D                                     t')
     D  userdata                       *   value
     D  depth                        10I 0 value
     ...
     D tns_getFileResponseRnmdEnd...
     D                 PR
     D                                     extproc('tns_getFileResponseRnmdEnd')
     D  userdata                       *   value
     D  depth                        10I 0 value
     D  namespace                  1024A   varying const
     D  name                       1024A   varying const
      ...
      *cOPERATION_UUID...
      *                C                   '10628801EB7119FF9FDD0004AC18DB29'
      *
 ...
 CPY  /COPY QWSDL2RPG,CLIB                         C Runtime Library
      ...
      * Returns  : getFileResponse
      * =====================================================================
     P ArchiveServerPort_getFile...
     P                 B                   export
     D                 PI                  likeds(tns_getFileResponse_t)
     D  i_tns_getFile                      likeds(tns_getFileRnmd_t)
     D  o_msg                       128A   varying
      *
      *  Return value
     D rtnValue        DS                  likeds(tns_getFileResponse_t)
     D                                     inz
      *
      *  Local fields
     D isUnexpectedError...
      ...
      *
      *  User data
     D userData        DS                  likeds(tns_getFileResponse_t)
     D                                     inz
      * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      /free
      ...
      * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      /free
         ...
         Marshaller_toStringV6(
            %addr(i_tns_getFileRnmd.key)
            : %addr(i_tns_getFileRnmd.key: *DATA)
            : %len(i_tns_getFileRnmd.key)
            : i_hOutStream
            );
 ...
 ERR P                 B
      ...
      *
      * ==================================================================
      * Return value: tns:getFileResponse
      * ==================================================================
     P tns_getFileResponseRnmdStart...
     P                 B
     D                 PI
     D  userdata                       *   value
     D  depth                        10I 0 value
     ...
     D                                     const options(*varsize)
      *
     D currentItem     DS                  likeds(tns_getFileResponseRnmd_t)
      ...
      /free
         ...
         when (path = '/Envelope/Body');
            ...
            other;
               XMLSAXParser_delegateElementProcessing(
                  userdata
                  : %paddr('tns_getFileResponseRnmdStart')
                  : %paddr('tns_getFileResponseRnmdEnd'));
              return;
            endsl;
