      ...
      *  and the required type definitions (aka reference fields).
      /DEFINE PROTOTYPE_MTOM01002
 CPY  /COPY ZENEXMPL/QWSDL,MTOM01002
      /UNDEFINE PROTOTYPE_MTOM01002
      *
      *  Program entry point
     D MTOM01002T...
     D                 PR
     D key                                 like(                                CHANGED
     D                                     tns_getFile_t.key)                   CHANGED
      *
     ...
     D parameters      DS                  likeds(tns_getFileRnmd_t)
     D                                     inz
      ...
      * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      /free
         ...
         // of the web service.
         //    assign values here
         //parameters.key = 'string';                                   CHANGED
         parameters.key = key;                                        //CHANGED
 ...
 B01     if (not ArchiveServerPort_Port_isError());
            ...
            text = 'File has been downloaded to ' +                   //CHANGED
                   ArchiveServerPort_Attachments_getAtPos(0);         //CHANGED
            sndMsg(text);                                             //CHANGED

            text = 'File has been downloaded to ' +                   //CHANGED
                   ArchiveServerPort_Attachments_getAtPos(1);         //CHANGED
            sndMsg(text);                                             //CHANGED

            text = 'File has been downloaded to ' +                   //CHANGED
                   ArchiveServerPort_Attachments_getAtPos(2);         //CHANGED
            sndMsg(text);                                             //CHANGED
